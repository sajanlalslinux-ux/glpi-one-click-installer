...
get_configuration() {
    ...
    read -p "Computer Name [$(hostname)]: " COMPUTER_NAME
    ...
    read -p "Update Interval [300]: " UPDATE_INTERVAL
...
install_dependencies() {
    ...
    case $OS in
        ubuntu|debian|linuxmint)
            ...
            apt-get install -y glpi-agent curl wget > /dev/null 2>&1
            ;;
